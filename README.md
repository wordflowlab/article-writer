...
**v0.5.0** (2025-10-26) 🚀 NEW
- ✅ **文档爬虫系统** - 自动爬取技术文档建立知识库
- ✅ 支持静态/动态页面和PDF文档提取
- ✅ SQLite全文搜索索引，智能分类
- ✅ 集成到 `/research` 命令，无缝使用
- ✅ 5个预设配置（Vue/React/TypeScript等）
- ✅ 实时进度显示和ETA预估
- 详见 [爬虫指南](docs/crawler-guide.md) | [快速测试](docs/crawler-quick-test.md)

**v0.4.1** (2025-10-26)
- ✅ 交互式样式配置器 (`/format-config` 命令)
- ✅ 11种预设主题色 + 自定义颜色支持
- ✅ 配置预设管理(保存/加载/重置)
- ✅ 三种配置方式:交互式/AI对话/手动编辑
- ✅ 完整的帮助系统和测试指南
- 详见 [发布说明](RELEASE_NOTES_v0.4.1.md) | [快速指南](docs/format-config-guide.md)

**v0.4.0** (2025-10-26)
- ✅ 微信公众号 Markdown 自动格式化(基于 doocs/md)
- ✅ 三大主题系统(default/grace/simple)
- ✅ 交互式主题选择(主题+颜色)
- ✅ 完整配置驱动(通过 `.content/config.json`)
- ✅ 集成到 `/publish` 命令，零学习成本
- ✅ HTML 预览生成，浏览器一键查看
- 详见 [微信格式化文档](docs/wechat-formatting.md)
