...
argument-hint: [brief文件路径或项目编号]
allowed-tools: Read(//*), Write(//_knowledge_base/**), WebSearch, WebFetch
scripts:
...
#### 模式A: 文档深度爬取 (推荐用于官方文档)
**识别特征:**
- Brief中提到需要深入了解某个框架/工具
- 用户提供了完整的文档网站 URL
- URL包含: docs., /docs/, /guide/, /api/, /documentation/
...
```bash
# 执行文档爬取
bash .specify/scripts/bash/research-docs.sh \
  --name "vue3-docs" \
